    ...
    >
      <div className={cls("w-content-width mx-auto flex flex-col gap-8", containerClassName)}>
        <TextBox
          ...
          titleClassName={cls("text-5xl font-medium", titleClassName)}
        ...
        <div className={cls("flex flex-col md:flex-row gap-6 md:items-stretch")}>
          ...
          <div className={cls("w-full md:w-4/10 2xl:w-3/10 rounded-theme card p-6 flex flex-col gap-6 items-center justify-center", contentClassName)}>
