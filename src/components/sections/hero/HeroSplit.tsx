...
const HeroSplit = ({
  ...
  const mediaContent = (
    <div className={cls("w-full md:w-1/2 overflow-hidden rounded-theme card p-4 md:max-h-[75svh]", mediaWrapperClassName)}>
      <MediaContent
        imageSrc={imageSrc}
        videoSrc={videoSrc}
        imageAlt={imageAlt}
  ...
  return (
    <section
      ...
      className={cls("w-full h-fit py-30 md:py-0 md:h-svh flex items-center", className)}
    >
      <div className={cls("w-content-width mx-auto flex flex-col md:flex-row gap-13 md:gap-15 items-center", containerClassName)}>
        ...
        <div className={cls("w-full md:w-1/2")}>
          <TextBox
            ...
            titleClassName={cls("text-7xl 2xl:text-8xl font-medium text-center md:text-left", titleClassName)}
