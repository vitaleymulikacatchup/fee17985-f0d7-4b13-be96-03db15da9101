...
export const metadata: Metadata = {
  title: "Tech Innovators: Elevate Your Business",
  description: "Discover top-notch IT solutions with Tech Innovators. Elevate your business today.",
  openGraph: {
    title: "Tech Innovators: Elevate Your Business",
    description: "Discover top-notch IT solutions with Tech Innovators. Elevate your business today.",
    siteName: "Tech Innovators",
    images: [{
